...
int main(int argc, char *argv[])
{
    ...
    Timer *timer = new Timer(break_duration, long_break_duration, timer_duration, n_short_breaks, state_file,
                             "files/notify.txt", "files/bell_1.wav");
    ...
    if (date->IsToday() && state_file->ValueOf("last_timer") != "break")
    {
        ...
        std::cout << "Last timer was: " + last_counts + " counts and " + last_timer + " left" << std::endl;
        do
        {
